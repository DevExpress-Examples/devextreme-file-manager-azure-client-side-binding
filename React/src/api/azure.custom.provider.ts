...
export function getAzureFileSystemProvider(endpointUrl: string, onRequestExecuted?: Function): CustomFileSystemProvider {
  return new AzureCustomProvider(endpointUrl, onRequestExecuted).fileSystemProvider;
}
